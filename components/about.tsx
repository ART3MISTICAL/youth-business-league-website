...
const AboutUs = () => {
	return (
		...
		<div className="h-[100vh] pt-[66px] flex z-[0] bg-[#021915]">
			<div className="w-full h-full flex flex-col justify-center items-center z-10 pb-[10vh]">
				<div className="w-[90vw] h-full flex flex-col justify-center items-center mb-[60px] mt-[30px] text-white rounded-3xl">
					<div className="text-[#fff] font-bold text-[30px] lg:text-[50px] pl-[5vw]" data-scroll data-scroll-direction="horizontal" data-scroll-speed="5">
						Well, Hello There!
					</div>
					<div className="text-[#fff] font-bold text-[20px] lg:text-[40px] pr-[5vw]" data-scroll data-scroll-direction="horizontal" data-scroll-speed="-5">
						Allow us to introduce ourselves...
					</div>
					<div className="w-[50%] h-[50%] flex justify-center items-center text-[#fff] font-bold text-[10px] lg:text-[20px] notonscreen aboutustext">
						We are the YBL

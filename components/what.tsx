...
const What = () => {
	return (
		...
		<div className="h-[100vh] w-[100vw] relative items-center justify-center" id="what">
			...
			<div className="relative z-10 w-[50vw] h-[30vh]">
			<HoverCarousel images={images} />
			</div>
			</div>
			
			<div className=" z-50 w-[100vw] bottom-0 flex justify-center items-center">
			<a href='#contact' className='bg-[#021915] rounded-full absolute z-10 w-16 h-16 bottom-5 flex justify-center items-center cursor-pointer notonscreen up border-[1.5px] border-[#f7aa1b] hover:border-[#021915] hover:bg-[#f7aa1b] text-[#f7aa1b] hover:text-[#021915]'>
